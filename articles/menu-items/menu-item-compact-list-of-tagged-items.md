<!-- Filename: Help4.x:Menu_Item:_Compact_List_of_Tagged_Items / Display title: Menu-item: Compacte lijst met getagde items -->
...
- *Gebruik algemeen:* Gebruik de waarde uit

<!-- Filename: Help4.x:Menu_Item:_Create_Request / Display title: Menu-item: Verzoek aanmaken -->

## Beschrijving

Het **Maak verzoek aan** menu-item type wordt gebruikt om een formulier
te tonen waar gebruikers een informatieverzoek kunnen inzenden
(exporteren of verwijderen).

## Hoe toegang te krijgen

Om een nieuw "Maak verzoek aan" menu-item aan te maken:
...
- Selecteer **Menu's → \[naam van het menu\]** vanuit het beheermenu
  ...
  - Selecteer in de modale dialoog het 'Privacy' item om een lijst te
    openen en selecteer daarna het **Maak verzoek aan** item.

Om een bestaand "Maak verzoek aan" menu-item te bewerken:
...
<img
src="https://docs.joomla.org/images/thumb/d/d0/Help-4x-Menus-Menu-Item-Privacy-Create-Request-screen-nl.png/800px-Help-4x-Menus-Menu-Item-Privacy-Create-Request-screen-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/d/d0/Help-4x-Menus-Menu-Item-Privacy-Create-Request-screen-nl.png 1.5x"
data-file-width="971" data-file-height="692" width="800" height="570"
alt="Menus Menu Item Privacy Create Request screen" />

<!-- Filename: Help4.x:Menu_Item:_List_All_Contact_Categories / Display title: Menu-item: Lijst met alle categorieën -->
...
Deze bepalen of een nieuwsfeed beschikbaar zal zijn voor de pagina en

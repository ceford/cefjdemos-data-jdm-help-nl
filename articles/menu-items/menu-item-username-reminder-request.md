<!-- Filename: Help4.x:Menu_Item:_Username_Reminder_Request / Display title: Menu-item: Herinneringsverzoek -->

## Beschrijving

Het **Aanvraag herinnering gebruikersnaam** menu-itemtype wordt gebruikt
om een formulier aan te maken dat een gebruiker de mogelijkheid geeft om
een e-mail met zijn gebruikersnaam aan te vragen.

## Hoe toegang te krijgen

Om een nieuwe **Aanvraag herinnering gebruikersnaam** menu-item aan te
maken:
...
Om een bestaand 'Aanvraag herinnering gebruikersnaam' menu-item te
bewerken:

- Selecteer de titel in de Menu: Item lijst.

## Schermafbeelding

<img
src="https://docs.joomla.org/images/thumb/e/e5/Help-4x-Menus-Menu-Item-User-Reminder-nl.png/800px-Help-4x-Menus-Menu-Item-User-Reminder-nl.png.jpeg"
decoding="async"
...
template en de template stijl van de Joomla! website.* Aanvraag
herinnering formulier: <img

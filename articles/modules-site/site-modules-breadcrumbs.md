<!-- Filename: Help4.x:Site_Modules:_Breadcrumbs / Display title: Site modules: Kruimelpaden -->

## Beschrijving

Deze module toont een stel navigatie-links die weergeeft waar u bent
binnen de web site en de mogelijkheid geeft terug te navigeren.
...
<img
src="https://docs.joomla.org/images/thumb/f/fd/Help-4x-modules-site-module-manager-module-breadcrumbs-nl.png/800px-Help-4x-modules-site-module-manager-module-breadcrumbs-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/f/fd/Help-4x-modules-site-module-manager-module-breadcrumbs-nl.png 1.5x"
data-file-width="1190" data-file-height="913" width="800" height="614"
...
- **Startpagina:** (*Toon*/*Verberg*). Toon of verberg het start element
  in het pad.
- **Tekst voor de startpagina:** Deze tekst wordt getoond als start. Als
  het veld leeg gelaten wordt, dan wordt de standaardwaarde uit het
  mod_breadcrumbs.ini taalbestand gebruikt.

<!-- Filename: Help4.x:Site_Modules:_Feed_Display / Display title: Site modules: Nieuwsfeed tonen -->

## Beschrijving

Deze Module toont een RSS-nieuwsfeed van een website. Deze module is
...
<img
src="https://docs.joomla.org/images/thumb/0/0f/Help-4x-modules-site-module-manager-module-feed-display-nl.png/800px-Help-4x-modules-site-module-manager-module-feed-display-nl.png"
decoding="async"
...
- **RTL Feed:** (*Ja*/*Nee*). Toon feed in RTL (van rechts naar links)
  richting.
- **Feedtitel:** (*Toon*/*Verberg*). Toon nieuwsfeed titel.

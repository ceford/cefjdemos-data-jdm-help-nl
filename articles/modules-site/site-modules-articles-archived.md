<!-- Filename: Help4.x:Site_Modules:_Articles_-_Archived / Display title: Site modules: Gearchiveerde artikelen -->

## Beschrijving

Deze module toont een lijst met kalendermaanden met gearchiveerde
artikelen. Nadat u de status van een artikel heeft gewijzigd naar
gearchiveerd, wordt deze lijst automatisch gegenereerd.
...
<img
src="https://docs.joomla.org/images/thumb/1/11/Help-4x-modules-site-module-manager-module-archived-articles-nl.png/800px-Help-4x-modules-site-module-manager-module-archived-articles-nl.png"
decoding="async"
...
template en de template stijl van de Joomla! website.* Gearchiveerde
artikelen module toont:

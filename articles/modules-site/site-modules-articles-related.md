<!-- Filename: Help4.x:Site_Modules:_Articles_-_Related / Display title: Site modules: Gerelateerde artikelen -->

## Beschrijving

Deze module toont een lijst met artikelen die zijn gerelateerd aan het
huidige artikel dat bekeken wordt door de gebruiker (bijvoorbeeld, een
artikel weergave of een blog of lijst weergave waar de gebruiker op een
...
<img
src="https://docs.joomla.org/images/thumb/e/e5/Help-4x-modules-site-module-manager-module-articles-related-articles-nl.png/800px-Help-4x-modules-site-module-manager-module-articles-related-articles-nl.png"
decoding="async"
...
meta keywords. Alle keywords van het huidige artikel worden vergeleken
met alle andere gepubliceerde..

- **Datum:** (*Toon*/*Verberg*). Toon of verberg de datum
...
- **Uitleggende tekst.** Deze module toont andere artikelen die
  gerelateerd zijn aan het artikel dat wordt bekeken. De verwantschap
  wordt bepaald door de trefwoorden. Alle trefwoorden van het huidige
  artikel worden vergeleken met de trefwoorden van alle andere
  gepubliceerde artikelen. Bijvoorbeeld, u heeft een artikel genaamd
  "Parkieten fokken" en een ander over "Handmatig opfokken zwarte
  kaketoes". Als het trefwoord "parkiet" in beide artikelen is
  toegevoegd, dan zal de module verwante items "Parkieten fokken" tonen
  als "Handmatig opfokken zwarte kaketoes" wordt gelezen en vice versa.
...
<img
src="https://docs.joomla.org/images/thumb/2/2a/Help-4x-modules-manager-admin-module-site-advanced-options-nl.png/800px-Help-4x-modules-manager-admin-module-site-advanced-options-nl.png"
decoding="async"

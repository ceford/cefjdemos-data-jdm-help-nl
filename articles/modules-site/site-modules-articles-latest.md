<!-- Filename: Help4.x:Site_Modules:_Articles_-_Latest / Display title: Site modules: Artikelen - Nieuwste -->

## Beschrijving

Het **Nieuwste artikelen** moduletype toont een lijst met recent
...
<img
src="https://docs.joomla.org/images/thumb/3/3b/Help-4x-modules-site-module-manager-module-articles-latest-nl.png/800px-Help-4x-modules-site-module-manager-module-articles-latest-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/3/3b/Help-4x-modules-site-module-manager-module-articles-latest-nl.png 1.5x"
data-file-width="1096" data-file-height="871" width="800" height="636"
alt="modules site module manager module articles latest" />
...
- **Weer te geven artikelen:** Het aantal weer te geven artikelen
  (standaard is 5).
- **Speciale artikelen:** (*Toon*/*Verberg*/*Toon alleen speciale
  artikelen*). Toon/Verberg artikelen aangemerkt als speciaal.
- **Volgorde:** (*Laatst toegevoegd eerst*/*Laatst bewerkt
  eerst*/*Recent gepubliceerd eerst*/*Recent geopend
  eerst*/*Willekeurige artikelen*). Laatst toegevoegd eerst: sorteer de
  artikelen met behulp van de aanmaakdatum. Laatst bewerkt eerst:
  sorteer de artikelen met behulp van de aanpassingsdatum. Recent
  gepubliceerd eerst: sorteer de artikelen met behulp van hun
  publicatiedatum. Recent geopend eerst: sorteer de artikelen met behulp
  van hun aanpassings- of aanmaakdatum.
...
<img
src="https://docs.joomla.org/images/8/89/Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-nl.png"
decoding="async" data-file-width="215" data-file-height="163"
width="215" height="163"
alt="Extensions Module Manager Articles Latest example output" />

De module type naam voor deze module is "mod_articles_latest". Het is
niet gerelateerd aan een andere component.

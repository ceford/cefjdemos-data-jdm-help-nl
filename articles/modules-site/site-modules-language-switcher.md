<!-- Filename: Help4.x:Site_Modules:_Language_Switcher / Display title: Site modules: Taalselectie -->

## Beschrijving

De **Taalselectie** module maakt het mogelijk te schakelen tussen
beschikbare inhoudstalen. Het selecteren van een taal brengt u naar de
startpagina voor die taal.
...
<img
src="https://docs.joomla.org/images/thumb/6/6a/Help-4x-modules-site-module-manager-module-language-switcher-nl.png/800px-Help-4x-modules-site-module-manager-module-language-switcher-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/6/6a/Help-4x-modules-site-module-manager-module-language-switcher-nl.png 1.5x"
data-file-width="1092" data-file-height="892" width="800" height="653"
...
- **Voor tekst:** Dit is de tekst of HTML die getoond wordt boven de
  taalselectie.
- **Na tekst:** Dit is de tekst of HTML die wordt getoond onder te
  taalselectie.
- **Gebruik uitklapmenu:** (*Ja*/*Nee*). Indien het op 'Ja' staat worden
  onderstaande parameters genegeerd. De content taalnamen worden getoond
  in een uitklaplijst.
- **Gebruik afbeeldingen van vlaggen:** (*Ja*/*Nee*). Indien op 'Ja',
  dan worden de te kiezen talen als vlag getoond. Anders worden de
  taalnamen gebruikt.
- **Horizontale weergave:** (*Ja*/*Nee*). Staat standaard op 'Ja',
  horizontaal tonen.
- **Actieve taal:** (*Ja*/*Nee*). Toon al dan niet de actieve taal.
...
<img
src="https://docs.joomla.org/images/f/f2/Help4x-Extensions-Module-Manager-Language-Switcher-example-output-nl.png"
decoding="async" data-file-width="214" data-file-height="135"
width="214" height="135"
alt="Help4x Extensions Module Manager Language Switcher example output nl.png" />

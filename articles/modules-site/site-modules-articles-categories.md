<!-- Filename: Help4.x:Site_Modules:_Articles_-_Categories / Display title: Site modules: Artikelen - Categorieën -->

## Beschrijving

De **Artikelen - Categorieën** module vertoont een lijst met categorieën
vanuit een hoofdcategorie. **Belangrijk:** Als de hootdcategorie geen
sub-categorieën heeft wordt de module niet getoond.
...
<img
src="https://docs.joomla.org/images/thumb/5/56/Help-4x-modules-site-module-manager-module-articles-categories-nl.png/800px-Help-4x-modules-site-module-manager-module-articles-categories-nl.png"
decoding="async"
...
- **Aantal artikelen:** (*Toon*/*Verberg*). Toon of verberg het aantal
  artikelen.
- **Subcategorieën:** (*Toon*/*Verberg*). Toon of verberg
  subcategorieën.
- **\# Eerste subcategorieën:** (*Alle*/*1*/*2*/*3*/*4*/*5*/*6*/...).
  Selecteer hier het aantal eerste niveau subcategorieën dat getoond
  moet worden. Standaard is alle.
- **Maximale niveaubereik:** (*Alle*/*1*/*2*/*3*/*4*/*5*/*6*/...).
...
<img
src="https://docs.joomla.org/images/thumb/7/7d/Help-4x-modules-manager-admin-module-latestactions-advanced-options-nl.png/800px-Help-4x-modules-manager-admin-module-latestactions-advanced-options-nl.png"
decoding="async"
...
werkelijke weergave is afhankelijk van het geïnstalleerde aanpaste
template en de template stijl van de Joomla! website.* Artikelen
categorieën module toont:

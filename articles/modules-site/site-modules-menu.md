...
Dit **Menu** moduletype stelt u in staat een menu op een gewenste
positie te plaatsen en op de gewenste webpagina's. Een website kan meer
dan een menu op een enkele pagina hebben en verschillende menu's op
...
<img
src="https://docs.joomla.org/images/thumb/5/50/Help-4x-modules-site-module-manager-module-menu-nl.png/800px-Help-4x-modules-site-module-manager-module-menu-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/5/50/Help-4x-modules-site-module-manager-module-menu-nl.png 1.5x"
data-file-width="1118" data-file-height="847" width="800" height="606"
...
- **Selecteer menu:** (*Over Joomla*/*Australische
  ...
  Selecteer een menu uit de lijst.
- **Basisitem:** (*Huidig*/...). Selecteer een menu-item dat als basis
  moet worden gebruikt bij het tonen van het menu. U moet het
  beginniveau op hetzelfde niveau of hoger instellen als het niveau van
  het base-item. Dit zal ervoor zorgen dat het menu getoond wordt op
  alle toegekende pagina's. Als huidig is geselecteerd dan wordt het
  actieve item gebruikt als basis. Dit zorgt ervoor dat het de module
  alleen getoond wordt als het bovenliggende menu-item actief is.
- **Startniveau:** (*1*/*2*/*3*/*4*/*5*/*6*/*7*/...). Niveau waarop het
  menu getoond wordt. Het instellen van het 'Startniveau' en
  'Eindniveau' op het zelfde nummer en 'Sub-menu items' op 'Toon' zal
  ervoor zorgen dat alleen dat niveau getoond wordt.
- **Eind niveau:** (*All*/*1*/*2*/*3*/*4*/*5*/*6*/...). Het niveau om te
  stoppen met renderen van het menu. Indien u voor 'Alle' kiest, worden
  alle niveaus getoond afhankelijk van de 'Sub-menu items' instelling.

<!-- Filename: Help4.x:Site_Modules:_Random_Image / Display title: Site modules: Willekeurige afbeelding -->

## Beschrijving

Het **Willekeurige afbeelding** moduletype toont een willekeurige
afbeelding vanuit een map.
...
<img
src="https://docs.joomla.org/images/thumb/1/1a/Help-4x-modules-site-module-manager-module-random-image-nl.png/800px-Help-4x-modules-site-module-manager-module-random-image-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/1/1a/Help-4x-modules-site-module-manager-module-random-image-nl.png 1.5x"
data-file-width="1091" data-file-height="889" width="800" height="652"
alt="modules site module manager module random image" />
...
Er zijn geen tips toegevoegd voor de willekeurige afbeelding module.

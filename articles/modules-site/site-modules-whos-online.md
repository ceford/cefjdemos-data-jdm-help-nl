<!-- Filename: Help4.x:Site_Modules:_Who%27s_Online / Display title: Site modules: Wie is online -->

## Beschrijving

Het **Wie is online** moduletype toont het aantal anonieme en
geregistreerde gebruikers die momenteel de website bezoeken.
...
<img
src="https://docs.joomla.org/images/thumb/4/4b/Help-4x-modules-site-module-manager-module-whos-online-nl.png/800px-Help-4x-modules-site-module-manager-module-whos-online-nl.png"
decoding="async"
...
- De meeste mensen gebruiken de "Wie is online" module liever niet als
  ze weinig bezoekers hebben.
- Als u de cache tijd voor deze module te hoog zet, zal het aantal
  getoonde bezoekers fout zijn aangezien de module gebruikers telt die
  uw site x minuten geleden bezochten.

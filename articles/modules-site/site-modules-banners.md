<!-- Filename: Help4.x:Site_Modules:_Banners / Display title: Site modules: Advertenties -->

## Beschrijving

De advertentie-module toont de actieve advertenties uit de component.
...
<img
src="https://docs.joomla.org/images/thumb/3/3a/Help-4x-modules-site-module-manager-module-banners-nl.png/800px-Help-4x-modules-site-module-manager-module-banners-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/thumb/3/3a/Help-4x-modules-site-module-manager-module-banners-nl.png/1200px-Help-4x-modules-site-module-manager-module-banners-nl.png 1.5x, https://docs.joomla.org/images/3/3a/Help-4x-modules-site-module-manager-module-banners-nl.png 2x"
data-file-width="1246" data-file-height="1261" width="800" height="810"
...
- **Aantal:** (*1*/*2*/*3*/*4*/*5*/*6*/*7*/...). Het aantal advertenties
  dat getoond moet worden (standaard 5).
- **Adverteerder:** (*Geen
  adverteerder*/*Boekwinkel*/*Joomla!*/*Winkel*). Selecteer alleen
  advertenties van een bepaalde adverteerder.
- **Categorie:** Selecteer advertenties uit een bepaalde categorie of
  een reeks Categorieën. Als er niets wordt geselecteerd dan worden
  standaard alle categorieën getoond.
- **Selecteer op trefwoord:** (*Ja*/*Nee*). Advertentie wordt
  geselecteerd op basis van vergelijken van de advertentie-tags met de
  meta keywords van het document.
- **Willekeurig:** (*Sticky, Volgorde*/*Sticky, Willekeurig*). Bepaal de
  volgorde van de advertenties.
- **Koptekts:** Tekst of HTML die getoond moet worden voor de groep met
  advertenties.

<!-- Filename: Help4.x:Admin_Modules:_Privacy_Dashboard / Display title: Beheerder modules: Privacy dashboard -->

## Beschrijving

Het **Privacy dashboard** moduletype toont informatie over
privacyverzoeken.
...
<img
src="https://docs.joomla.org/images/thumb/0/04/Help-4x-modules-manager-admin-module-privacydashboard-nl.png/800px-Help-4x-modules-manager-admin-module-privacydashboard-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/0/04/Help-4x-modules-manager-admin-module-privacydashboard-nl.png 1.5x"
data-file-width="1097" data-file-height="860" width="800" height="627"
alt="modules manager admin module privacydashboard" />
...
## Verschijning op het dashboard

Deze module toont het type verzoek (*Export* of *Verwijder*), de status
van het verzoek (*In afwachting* of *Bevestigd*) en het aantal
verzoeken.

<img
src="https://docs.joomla.org/images/8/8e/Help-4x-modules-manager-admin-module-privacydashboard-cpanel-nl.png"
decoding="async" data-file-width="435" data-file-height="163"
width="600" height="225"
alt="modules manager admin module privacydashboard cpanel" />

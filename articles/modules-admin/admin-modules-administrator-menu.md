<!-- Filename: Help4.x:Admin_Modules:_Administrator_Menu / Display title: Beheerder modules: Beheerder menu -->

## Beschrijving

Het **Beheerder menu** moduletype toont de hoofd beheerder menu module.
...
<img
src="https://docs.joomla.org/images/thumb/a/aa/Help-4x-modules-administrator-module-manager-module-administrator-menu-nl.png/800px-Help-4x-modules-administrator-module-manager-module-administrator-menu-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/a/aa/Help-4x-modules-administrator-module-manager-module-administrator-menu-nl.png 1.5x"
data-file-width="1091" data-file-height="860" width="800" height="631"
alt="modules administrator module manager module administrator menu" />
...
- **Helpmenu.** Toont de Help-knop in de werkbalk.
- **Nederlands JoomlaCommunity forum.** Voer de URL in van een ander

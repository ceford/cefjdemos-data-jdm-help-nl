<!-- Filename: Help4.x:Admin_Modules:_Toolbar / Display title: Beheerder modules: Werkbalk -->

## Beschrijving

Het **Werkbalk** moduletype toont de werkbalkiconen waarmee acties op
...
<img
src="https://docs.joomla.org/images/thumb/2/2a/Help-4x-modules-administrator-module-manager-module-toolbar-nl.png/800px-Help-4x-modules-administrator-module-manager-module-toolbar-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/2/2a/Help-4x-modules-administrator-module-manager-module-toolbar-nl.png 1.5x"
data-file-width="1094" data-file-height="868" width="800" height="635"
alt="modules administrator module manager module toolbar" />

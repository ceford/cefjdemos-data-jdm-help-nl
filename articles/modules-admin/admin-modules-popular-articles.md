<!-- Filename: Help4.x:Admin_Modules:_Popular_Articles / Display title: Beheerder modules: Populaire artikelen -->

## Beschrijving

Het **Populaire artikelen** moduletype toont een lijst met populairste
gepubliceerde artikelen die nog actueel zijn. Sommige die getoond worden
kunnen verlopen zijn ondanks dat ze recent zijn.
...
<img
src="https://docs.joomla.org/images/thumb/d/d3/Help-4x-modules-administrator-module-manager-module-popular-articles-form-nl.png/800px-Help-4x-modules-administrator-module-manager-module-popular-articles-form-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/d/d3/Help-4x-modules-administrator-module-manager-module-popular-articles-form-nl.png 1.5x"
data-file-width="1091" data-file-height="876" width="800" height="642"
alt="modules administrator module manager module popular articles form" />

<!-- Filename: Help4.x:Admin_Modules:_Quick_Icons / Display title: Beheerder modules: Snelkoppelingen -->

## Beschrijving

Het **Snelkoppelingen** moduletype toont snelle iconen die zichtbaar
zijn op het dashboard (beheerder gebied startpagina).
...
<img
src="https://docs.joomla.org/images/thumb/e/ea/Help-4x-modules-manager-admin-module-quickicon-nl.png/800px-Help-4x-modules-manager-admin-module-quickicon-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/e/ea/Help-4x-modules-manager-admin-module-quickicon-nl.png 1.5x"
data-file-width="1099" data-file-height="892" width="800" height="649"
alt="modules manager admin module quickicon" />
...
- **Groep.**
- **Kop icoon.** De Font Awesome icoon-code.
- **Algemene instellingen icoon.**
- **Check-in icoon.**
- **Cache icoon.**
- **Gebruiker icoon.**
- **Artikel icoon.**

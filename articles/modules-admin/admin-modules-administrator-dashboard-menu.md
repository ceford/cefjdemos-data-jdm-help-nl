<!-- Filename: Help4.x:Admin_Modules:_Administrator_Dashboard_Menu / Display title: Beheerder modules: Beheerder dashboard menu -->

## Beschrijving

Het **Beheerder dashboard menu** moduletype toont een serie menu's in
een beheerders dashboard.
...
<img
src="https://docs.joomla.org/images/thumb/3/3e/Help-4x-modules-administrator-module-manager-module-dashboard-menu-nl.png/800px-Help-4x-modules-administrator-module-manager-module-dashboard-menu-nl.png"
decoding="async"
...
- **Informatie.** Deze module toont een collectie van menu's in een
  beheerder dashboard.
- **Menu.** Gebruik voorinstelling is momenteel de enige optie.

<!-- Filename: Help4.x:Admin_Modules:_Logged-in_Users / Display title: Beheer modules: Ingelogde gebruikers -->
...
alt="modules administrator module manager logged in users" />

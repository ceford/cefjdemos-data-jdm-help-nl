<!-- Filename: Help4.x:Admin_Modules:_Multilingual_Status / Display title: Beheerder modules: Meertalige status -->

## Beschrijving

Het **Meertalige status** moduletype toont een icoon in de titelbalk die
toegang tot de meertaligheid parameters biedt in meertalige websites.
<img
...
<img
src="https://docs.joomla.org/images/thumb/f/f4/Help-4x-modules-administrator-module-manager-module-multilingual-status-form-nl.png/800px-Help-4x-modules-administrator-module-manager-module-multilingual-status-form-nl.png"
decoding="async"
...
<img
src="https://docs.joomla.org/images/thumb/2/22/Help-4x-modules-administrator-module-manager-module-multilingual-status-report-nl.png/600px-Help-4x-modules-administrator-module-manager-module-multilingual-status-report-nl.png"
decoding="async"

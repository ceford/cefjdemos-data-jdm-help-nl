<!-- Filename: Help4.x:Admin_Modules:_Feed_Display / Display title: Beheerder modules: Nieuwsfeed tonen -->

## Beschrijving

De **Feed weergave** Module toont een RSS-nieuwsfeed van een website.
Deze module is niet gerelateerd aan de nieuwsfeed component of de
nieuwsfeed weergave en is een alternatief die de mogelijkheid geeft een
feed te tonen op een module-positie.
...
<img
src="https://docs.joomla.org/images/thumb/8/8c/Help-4x-modules-administrator-module-manager-module-feed-display-nl.png/800px-Help-4x-modules-administrator-module-manager-module-feed-display-nl.png"
decoding="async"
...
- **RTL Feed.** (*Ja*/*Nee*). Toon feed in RTL (van rechts naar links)
  richting.
- **Feeddatum.** (*Ja*/*Nee*). Toon nieuwsfeed datum.
- **Feedbeschrijving.** (*Toon*/*Verberg*). Toont de beschrijving voor
  de gehele feed.
- **Feedafbeelding.** (*Toon*/*Verberg*). Toont de afbeelding die
  gerelateerd is aan de gehele feed.
- **Items om weer te geven.** Geef het aantal RSS items dat getoond moet
  worden aan.
- **Itembeschrijving.** (*Toon*/*Verberg*). Toon de beschrijving of
...
## Beheerder afbeelding

Een voorbeeld van een nieuwsfeed wordt hieronder getoond:

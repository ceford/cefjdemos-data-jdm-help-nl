<!-- Filename: Help4.x:Admin_Modules:_Login_Form / Display title: Beheerder modules: Inlogformulier -->

## Beschrijving

Het **Inlogformulier** moduletype toont een gebruikersnaam en wachtwoord
inlogformulier. Het moet niet gedepubliceerd worden.
...
<img
src="https://docs.joomla.org/images/thumb/c/cf/Help-4x-modules-administrator-module-manager-module-login-form-nl.png/800px-Help-4x-modules-administrator-module-manager-module-login-form-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/c/cf/Help-4x-modules-administrator-module-manager-module-login-form-nl.png 1.5x"
data-file-width="1094" data-file-height="865" width="800" height="633"
alt="modules administrator module manager module login form" />

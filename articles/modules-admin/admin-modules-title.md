<!-- Filename: Help4.x:Admin_Modules:_Title / Display title: Beheerder modules: Titel -->

## Beschrijving

Het **Titel** moduletype toont de werkbalk componenttitel.
...
<img
src="https://docs.joomla.org/images/thumb/5/53/Help-4x-modules-administrator-module-manager-module-title-nl.png/800px-Help-4x-modules-administrator-module-manager-module-title-nl.png"
decoding="async"
srcset="https://docs.joomla.org/images/5/53/Help-4x-modules-administrator-module-manager-module-title-nl.png 1.5x"
data-file-width="1094" data-file-height="870" width="800" height="636"
alt="modules administrator module manager module title" />
...
- **Informatie.** Deze module toont de werkbalk componenttitel.
